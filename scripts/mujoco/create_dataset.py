...
ENV_IDS = [
    ...
    ("HalfCheetah", ("expert", "random", "simple", "medium", "medium-expert", "medium-replay"), 1_000_000, "TQC"),
    ("Hopper", ("expert", "random", "simple", "medium", "medium-expert", "medium-replay"), 1_000_000, "SAC"),
    ("Walker2d", ("expert", "random", "simple", "medium", "medium-expert", "medium-replay"), 1_000_000, "SAC"),
    ("Swimmer", ("expert", "random", "medium", "medium-expert", "medium-replay"), 1_000_000, "PPO"),
    ("Ant", ("expert", "random", "simple", "medium", "medium-expert", "medium-replay"), 1_000_000, "SAC"),
    ("Humanoid", ("expert", "random", "simple", "medium", "medium-expert", "medium-replay"), 1_000_000, "TQC"),
    ("HumanoidStandup", ("expert", "random", "simple", "medium", "medium-expert", "medium-replay"), 1_000_000, "SAC", 348),
]
...
def collect_replay_data(env, env_id, algo, proficiency):
    ...
    model = initialize_model(algo, "MlpPolicy")
    model.learn(total_timesteps=TIMESTEPS[f"{env_id}-{proficiency}"], log_interval=2)
        ...
        for proficiency in proficiencies:
            ...
            if proficiency == "medium-expert":
                ...
                if "medium-replay" in proficiency:
                    policy = collect_replay_data(env, env_id, algo, proficiency)
                else:
